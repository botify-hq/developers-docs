...
- data sample info
- orphans URLs counts. Orphan URLs are URLs which are **not in your website structure** (or in the scope of your crawl) but which received visits according to Google Analytics.
